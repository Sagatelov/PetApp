...
protocol AuthViewModelDelegat: AnyObject {
    func didReceveData()
}
...
class AuthViewController: UIViewController, UITextFieldDelegate {
    ...
    private var viewModel: AuthViewModelPorotocol!
    private var updateBarButton: UIBarButtonItem!
    
    
    weak var delegat: AuthViewModelDelegat?
    
    static func initUserEdit(viewModel: AuthViewModelPorotocol) -> AuthViewController {
        let controler = AuthViewController()
    ...
    private func bind(to viewModel: AuthViewModelPorotocol) {
